                    ...
                    <div class="entry"><br><br>
                                <%
                                    try {
                                        ...
                                        PreparedStatement ps = con.prepareStatement("select roll_no,user_name,email,dept,cno from student");
                                    ...
                                    <br><br><br>
                                                <table border="1">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td> <a href=<%= "\"delete_student.jsp?pemail=" + rs.getString(3) + "\""%> > Delete</a></td>
                                                    </tr>
                                                    <%}
                                                        } catch (Exception e) {
                                                            e.printStackTrace();
