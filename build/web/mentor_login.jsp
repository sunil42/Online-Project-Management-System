        ...
        <div id="page">
            <div id="content">
                <div class="post">
                    ...
                    <div class="entry">
                        <form action="mentor_login_process.jsp" method="post" id="plog" onSubmit="return loginval();" name="login">
                            <br></br>
                            <center>
                                <h2>mentor Login</h2>
                                <br><br>
                                        <table>
                                            ...
                                            <tr>
                                                <td>
                                                    <div><p>New Professor ? </p> <a href="mentor_register.jsp" class="links">Register Here</a></div>
