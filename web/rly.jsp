...
<%
    ...
    String semail = "gopikrishna008@gmail.com";
        ...
        <div id="header">
            <div id="menu">
                <ul>
                    ...
                    <li><a href="student_home.jsp" class="first">reply</a></li>
                </ul>
            </div>
            <div id="search">
                    ...
                    <div class="entry"><br><br>
                                <%
                                    try {
                                        ...
                                        PreparedStatement ps = con.prepareStatement("select from_mail,to_mail,subject,message from discussion where to_mail=?");
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <li>
                                                                ...
                                                                <p><marquee>Latest Documents on Java</marquee></p>
                                                                <p><marquee>Latest Documents on Dotnet</marquee></p>
                                                            </li>
                                                        </li>
                                                        <li>
                                                            <h2>Categories  </h2>
