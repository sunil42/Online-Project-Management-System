        ...
        <div id="page">
            <div id="content">
                <div class="post">
                    ...
                    <div class="entry">
                        <form action="professor_login_process.jsp" method="post" id="plog" onSubmit="return loginval();" name="login">
                            <br></br>
                            <center>
                                ...
                                <br><br>
                                        <table>
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="submit" form="plog" align="right" value='Submit' />
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div><p>New Professor ? </p> <a href="professor_register.jsp" class="links">Register Here</a></div>
                                                    
                                                </td>
                                            </tr>
                                             <tr>
                                                <td>
                                                    <div><p>Forgot Password? </p> <a href="professor_forgot.jsp" class="links">Click Here</a></div>
                                        ...
                                        <div id="sidebar">
                                            <ul>
                                                ...
                                                <li>
                                                    <h2>Categories </h2>
                                                    <ul>
                                                        <li><a href="professor_register.jsp">Register </a></li>
